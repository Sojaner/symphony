...
Set each Agent/Task `description` to start with `symphony_assessor [<model>/<effort>]:` or `symphony_lead [<model>/<effort>]:` for its assigned role, substituting the routing actually requested.
